...
```bash
git clone https://github.com/HaidaMarese/SnakesAndLadder-DigitalEdition.git
```
###  How to Run

1. **Open with Unity Hub**
   - Recommended version: **Unity 2021 LTS or newer**
...
- Move the player token according to dice value

**Tile interactions:**
-  **Ladder →** climb upward
-  **Snake →** slide downward
...
This project was created for learning and academic development.  
It reflects my practical understanding of:

- C# scripting in Unity
- Event-driven gameplay mechanics
- UI systems, canvases, and prefab usage
- Asset management and Unity project structure
- Animation workflow
...
**Haida Makouangou **  
Computer Science Student - AI, Gaming,  and  Robotics
